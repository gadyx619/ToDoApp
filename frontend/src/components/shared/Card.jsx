...
import { faTrash, faPenToSquare,faShare } from "@fortawesome/free-solid-svg-icons";
...
const Card = ({ task, todoId, setTodoState, todoState, fetchTodosData }) => {
  ...
  return (
    <div className="flex flex-col	justify-between bg-white dark:bg-gray-800 w-72 shadow-lg rounded-xl p-4vfont-['Poppins']">
      {/* Edit Task modal */}
      {isedit && (
