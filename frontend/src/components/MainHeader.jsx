...
const MainHeader = ({ getSearchInput }) => {
  ...
  return (
    <div className="container mx-auto flex flex-wrap gap-1 justify-center md:justify-between items-center text-xs sm:text-base py-2 px-4 flex-col sm:flex-row font-['Poppins']">
      <div className="flex items-center mr-2">
      <h6 className="text-3xl font-bold mt-0 mb-6">ToDoApp</h6>
      </div>
